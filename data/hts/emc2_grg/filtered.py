...
This stage filters out observations which live or work outside of the
area.
"""
...
def configure(context):
    """Configure."""
    context.stage("data.hts.emc2_grg.cleaned")
...
def execute(context):
    ...
    df_households, df_persons, df_trips = context.stage("data.hts.emc2_grg.cleaned")
